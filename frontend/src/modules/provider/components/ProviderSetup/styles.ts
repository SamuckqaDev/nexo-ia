...
export const TestResult = styled.p<{ $ok: boolean }>`margin:0;font-size:.8rem;line-height:1.5;color:${({theme,$ok})=>$ok?theme.colors.statusOnline:theme.colors.accentSoft};`;
