...
const graph: BackendKnowledgeGraph = {
  nodes: [
    { ...owner, id: `vault:${vaultId}`, kind: "VAULT", vaultId, sourceId: null, ordinal: null, label: "Nexo Knowledge Base", detail: "2 sources", excerpt: "Product knowledge", status: "PERSONAL" },
    { ...owner, id: `source:${firstSourceId}`, kind: "SOURCE", vaultId, sourceId: firstSourceId, ordinal: null, label: "Vision.md", detail: "1 chunk", excerpt: null, status: "READY" },
    { ...owner, id: `source:${secondSourceId}`, kind: "SOURCE", vaultId, sourceId: secondSourceId, ordinal: null, label: "Principles.md", detail: "1 chunk", excerpt: null, status: "READY" },
    { ...owner, id: "chunk:aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaaa", kind: "CHUNK", vaultId, sourceId: firstSourceId, ordinal: 0, label: "Chunk 1", detail: "20 estimated tokens", excerpt: "Local-first knowledge", status: "EMBEDDED" },
    { ...owner, id: "chunk:bbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbbbbbb", kind: "CHUNK", vaultId, sourceId: secondSourceId, ordinal: 0, label: "Chunk 1", detail: "18 estimated tokens", excerpt: "Private local context", status: "EMBEDDED" }
  ],
  edges: [
